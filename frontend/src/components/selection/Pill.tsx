...
export function Pill({
  ...
  const activeClasses =
    tone === "orange"
      ...
      : "border-indigo-700 bg-indigo-600 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]";
  const inactiveClasses =
    tone === "orange"
      ? "border-amber-200 bg-amber-50/80 text-amber-900 hover:border-amber-300 hover:bg-amber-100"
      : "border-slate-200 bg-slate-50/80 text-slate-900 hover:border-indigo-300 hover:bg-indigo-50";
  const sizeClasses =
    size === "compact"
